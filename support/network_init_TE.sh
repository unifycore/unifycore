...
ip link add eth2 type veth peer name corea2
ip link add eth3 type veth peer name corec3
...
ip link add corea5 type veth peer name coref1
ip link add corec3 type veth peer name coref2
...
btsInterfaces=(eth2)
commonInterfaces=( corea3 corea4 corea5 coreb2 corec1 corec2 corec3 cored3 coreb1 cored1 cored2 coreb3 coree2 coree1 )
